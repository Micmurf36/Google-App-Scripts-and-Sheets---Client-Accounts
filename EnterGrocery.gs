function submitGroceryTrans() {
  var myGooglSheet = SpreadsheetApp.getActiveSpreadsheet();
  var shUserForm = myGooglSheet.getSheetByName("Enter Grocery");
  ...
  if (validateTransGrocery()==true) {
    ...
    datasheet.getRange(blankRow, 4).setValue(-1 * Math.abs(shUserForm.getRange("B10").getValue()).toFixed(2));
...
function validateTransGrocery(){
 
  var myGooglSheet= SpreadsheetApp.getActiveSpreadsheet(); //declare a variable and set with active google sheet 
  var shUserForm    = myGooglSheet.getSheetByName("Enter Grocery"); //delcare a variable and set with the User Form worksheet
...
function searchRecordTransGrocery() {
  var myGooglSheet = SpreadsheetApp.getActiveSpreadsheet(); //declare a variable and set with active google sheet 
  var shUserForm = myGooglSheet.getSheetByName("Enter Grocery"); //delcare a variable and set with the User Form worksheet
...
function clearFormTransGrocery() 
{
  var myGoogleSheet= SpreadsheetApp.getActiveSpreadsheet(); //declare a variable and set with active google sheet 
  var shUserForm    = myGoogleSheet.getSheetByName("Enter Grocery"); //declare a variable and set with the User Form worksheet
...
function modifyRecordTransGrocery() {
  var myGooglSheet = SpreadsheetApp.getActiveSpreadsheet(); //declare a variable and set with active google sheet 
  var shUserForm = myGooglSheet.getSheetByName("Enter Grocery"); //declare a variable and set with the Account Entry worksheet
...
function deleteRecordTransGrocery() {
  var myGooglSheet = SpreadsheetApp.getActiveSpreadsheet(); //declare a variable and set with active google sheet 
  var shUserForm = myGooglSheet.getSheetByName("Enter Grocery"); //declare a variable and set with the Account Entry worksheet
  var datasheet = myGooglSheet.getSheetByName("Data"); //declare a variable and set with the Database worksheet
